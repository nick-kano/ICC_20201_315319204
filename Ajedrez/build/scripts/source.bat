...
set CLASSPATH=%APP_HOME%\lib\source.jar;%APP_HOME%\lib\core.jar

@rem Execute source
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SOURCE_OPTS%  -classpath "%CLASSPATH%" gui.ChessGUI %CMD_LINE_ARGS%
